package sahisti.dailyChallenge.controller;

import sahisti.dailyChallenge.controller.dto.*;
...
public class DailyChallengeController {
    ...
    public ResponseEntity<Boolean> makeAMove(@PathVariable Long id, @Valid @RequestBody sahisti.ChessGame.controller.dto.AnswerDTO answerDTO) throws Exception {
